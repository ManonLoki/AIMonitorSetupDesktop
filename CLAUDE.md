...
pnpm run build:win       # intentionally unsigned Windows x64 NSIS through cargo-xwin
pnpm release:desktop     # signed/notarized macOS + unsigned Windows installers and checksums
```
